      ...
      <div className="max-w-7xl mx-auto p-6 relative z-10">
        <div className="mb-8 animate-slide-up">
          <div className="text-center mb-8">
            <h1 className="text-5xl font-black gradient-text mb-4 animate-text-glow">My Attendance</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <div className="card-premium p-6 hover-glow-green">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-400 uppercase tracking-wider">Present Today</p>
                  <div className="flex items-center">
            ...
            <div className="card-premium p-6 hover-glow-cyan">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-400 uppercase tracking-wider">Overall %</p>
                  <div className="flex items-center">
            ...
            <div className="card-premium p-6 hover-glow-purple">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-400 uppercase tracking-wider">This Month</p>
                  <div className="flex items-center">
            ...
            <div className="card-premium p-6 hover-glow-orange">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-400 uppercase tracking-wider">Class Average</p>
                  <div className="flex items-center">
          ...
          <div className="p-6">
            {rows.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-xl text-gray-400 mb-2">No attendance records found</p>
                <p className="text-gray-500">Your attendance records will appear here once marked by faculty</p>
              </div>
            ) : (
              <div className="space-y-4">
                {rows.map((r) => (
                  <div key={r._id} className="flex items-center justify-between p-4 bg-gray-800/50 rounded-2xl hover:bg-gray-700/50 transition-all">
                    <div className="flex items-center">
                      <div className="bg-cyan-500/20 p-3 rounded-xl mr-4">
                        <Calendar className="w-5 h-5 text-cyan-400" />
                      </div>
                      <div>
                        <p className="font-semibold text-white">{r.courseId?.title} ({r.courseId?.code})</p>
